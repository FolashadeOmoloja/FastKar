...
const Header = () => {
  return (
   <header className="bg-color pr-[40px] max-xsm:pr-[10px] flex justify-between items-center h-[100px]  shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] border-b-2 border-[rgba(0,_0,_0,_0.24)] ">
       <section>
          <Image 
